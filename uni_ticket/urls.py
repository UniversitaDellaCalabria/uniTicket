...
urlpatterns = [
    ...
    path('<str:structure_slug>/<str:category_slug>/conditions/<int:condition_id>/download/attachment', generic.download_condition_attachment, name='download_condition_attachment'),
...
urlpatterns += [
    ...
    path('{}/manager_all_tickets.json'.format(structure), datatables.manager_all_tickets, name='manager_all_tickets_json'),
    ...
    path('{}/operator_all_tickets.json'.format(structure), datatables.operator_all_tickets, name='operator_all_tickets_json'),
]
...
urlpatterns += [
    ...
    path('{}/dependence/remove/<str:main_ticket_id>/'.format(ticket_id), management.ticket_dependence_remove, name='remove_ticket_dependence'),
