    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protocollo_uo', models.CharField(blank=True, default='', max_length=12, verbose_name='UO')),
                ('protocollo_email', models.EmailField(blank=True, help_text='Se vuoto: amministrazione@pec.unical.it', max_length=255, null=True, verbose_name='E-mail')),
        ...
        migrations.AlterModelOptions(
            ...
            options={'ordering': ['-created'], 'verbose_name': 'Configurazione WS Protocollo Categoria', 'verbose_name_plural': 'Configurazioni WS Protocollo Categorie'},
        ),
