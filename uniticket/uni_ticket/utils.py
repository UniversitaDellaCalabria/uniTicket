...
def export_input_module_csv(
    ...
    for richiesta in richieste:
        ...
        row = [
            ...
            getattr(richiesta.compiled_by, 'taxpayer_id', None),
            getattr(richiesta.compiled_by, 'email', None),
            getattr(richiesta.compiled_by, EMPLOYEE_ATTRIBUTE_NAME, None),
            getattr(richiesta.compiled_by, USER_ATTRIBUTE_NAME, None),
            richiesta.created_by or _('Utente anonimo'),
            getattr(richiesta.created_by, 'taxpayer_id', None),
            getattr(richiesta.created_by, 'email', None),
