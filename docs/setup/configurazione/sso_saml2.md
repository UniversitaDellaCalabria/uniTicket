...
Per rendere operativa l'autenticazione tramite SAML2, è necessario includere le applicazioni **djangosaml2** e **saml2_sp** all'interno della lista [INSTALLED_APPS](parametri-avanzati.md#lista-app-installate) nel proprio settingslocal.py:
