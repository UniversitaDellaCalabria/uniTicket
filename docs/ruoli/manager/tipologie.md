...
![Detail](images/category_detail.png)
...
![Modules](images/category_input_modules.png)
...
![Module](images/category_input_module_detail.png)

## Clausole di accettazione

L’inserimento delle Clausole di accettazione obbligatorie è indipendente dal modulo utilizzato e si applica ai ticket creati per la tipologia in questione.

Una clausola può essere creata/modificata/disattivata/eliminata dal manager facilmente.

![Conditions](images/category_condition.png)