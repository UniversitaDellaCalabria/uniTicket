...
E’ possibile abbandonare o condividere la competenza del ticket con altri uffici, per motivi organizzativi e gestionali, o scegliere di trasferirla scegliendo di:

* abbandonare completamente i propri privilegi di gestione del ticket;
* mantenere ancora l’accesso ma in sola lettura.

![Ticket](../images/ticket_competence.png)
...
![Ticket](../images/ticket_task.png)

![Ticket](../images/ticket_task_detail.png)
...
![Ticket](../images/ticket_dependence.png)